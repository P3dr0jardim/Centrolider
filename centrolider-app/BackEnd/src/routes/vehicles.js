...
router.patch('/bulk-leasing-mensal', vehiclesController.bulkSetLeasingMensal);
...
router.put('/:id/leasing-mensal', vehiclesController.setLeasingMensal);
router.delete('/:id/leasing-mensal/:mes', vehiclesController.deleteLeasingMensal);
